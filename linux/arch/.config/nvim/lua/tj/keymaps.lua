...
keymap('n', '<Leader><Leader>np', ':Neorg workspace personal<CR>', opts)
keymap('n', '<Leader><Leader>nw', ':Neorg workspace work<CR>', opts)
keymap('n', '<Leader><Leader>[', 'za', opts)

-- NOTES
keymap('n', '<leader>np', ":Neorg workspace personal<CR>", opts)
keymap('n', '<leader>nw', ":Neorg workspace work<CR>", opts)
keymap('n', '<leader>[', 'za', opts)
