...
tokyo.setup({
  ...
  on_highlights = function(highlights, colors)
   highlights.LineNr = {fg=colors.teal, bold=false}
   highlights.CursorLineNr = {fg = colors.yellow, bold=true}
   highlights.Comment = {fg = colors.blue0}
   highlights.Visual = {bg="#015750"}
    highlights.CursorLine = {bg = "#222255", blend=10}
  end,
})
...
--vim.cmd([[hi LineNr guifg=#E6E1DE ctermbg=NONE gui=NONE]])
